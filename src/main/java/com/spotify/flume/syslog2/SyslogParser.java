...
public class SyslogParser implements Closeable {
	...
	**/
	private Event.Priority getEventPriorityBySyslog(int priority) {
		...
		case 0:
		case 1:
		case 2: return Event.Priority.FATAL;
		case 3: return Event.Priority.ERROR;
		case 4: return Event.Priority.WARN;
		case 5:
		case 6: return Event.Priority.INFO;
		case 7: return Event.Priority.DEBUG;
		default:
